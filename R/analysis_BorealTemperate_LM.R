...
lm6 <- lm(lrr ~ Biome + N_added + I(N_added^2), lc_rr_smmry)
lm7 <- lm(lrr ~ Biome + N_added               , lc_rr_smmry)
lm8 <- lm(lrr ~         N_added + I(N_added^2), lc_rr_smmry)
AICc(lm6, lm7, lm8)
lm9 <- lm(lrr ~         N_added               , lc_rr_smmry)
AICc(lm8, lm9)
visreg(lm8, xvar = "N_added")

anova(lm3, lm4)
summary(lm3)
anova(lm4)
plot(lm4)
visreg(lm4, xvar = "N_added")
visreg(lm4, xvar = "CNratio")
summary(lm4)
